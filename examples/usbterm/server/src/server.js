...
import { createHidObject } from './hid';
import async from 'async';

import { createAppObject } from './app';

let appObject = createAppObject();
let hidObject = createHidObject();

monObjectFactory.insertObject('hid', hidObject);
